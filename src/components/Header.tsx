...
const Header = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 border-b border-border shadow-lg shadow-black/5 backdrop-blur-xl`} style={{ background: 'linear-gradient(90deg, hsl(217 90% 61% / 0.25), hsl(9 81% 56% / 0.2), hsl(43 96% 50% / 0.2), hsl(142 53% 43% / 0.25), hsl(217 90% 61% / 0.2)), hsl(0 0% 100% / 0.75)' }}>
      <div className="absolute bottom-0 left-0 right-0 h-[4px]" style={{ background: 'linear-gradient(90deg, #4285F4, #EA4335, #FBBC04, #34A853)' }} />

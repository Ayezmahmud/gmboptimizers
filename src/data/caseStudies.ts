...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    testimonialQuote: "We bake the best sourdough in Manchester but nobody could find us. GB Optimizers changed everything. We now have queues out the door every Saturday morning.",
  ...
  },
  {
    ...
    testimonialQuote: "GB Optimizers understood the regulatory landscape and delivered without ever risking our ICAEW standing. Our best tax season in 22 years.",
  ...
  },
  {
    ...
    testimonialQuote: "We roast better coffee than Starbucks but nobody knew we existed. GB Optimizers put us on the map — literally. Now we're Austin's #1 roaster.",
  ...
  },
  {
    ...
    testimonialQuote: "As a Black woman in HVAC, I never thought we'd outrank the national franchises. GB Optimizers made it happen. Our phones don't stop ringing.",

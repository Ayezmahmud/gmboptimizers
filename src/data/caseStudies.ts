...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    testimonialQuote: "My family has been making pasta for three generations, but we were losing customers to restaurants with better Google presence. GB Optimizers brought the digital world in line with our food quality. We're now the #1 Italian restaurant in our area, and for the first time ever, we're turning away walk-ins on weeknights. Incredible.",
  ...
  },
  {
    ...
    testimonialQuote: "For 18 years I built my reputation through handshakes and open homes. But the world moved online, and the franchise agencies were eating our lunch on Google. GB Optimizers gave us the digital presence to match our real-world expertise. We're now the #1 ranked agency in 3 suburbs, and vendors are coming to us instead of us chasing them. It's transformed how we do business.",
  ...
  },
  {
    ...
    testimonialQuote: "GB Optimizers understood the unique challenges of the UK dental market. They navigated GDC regulations beautifully and delivered results beyond our expectations. We're now the most visible practice in Marylebone.",
  ...
  },
  {
    ...
    testimonialQuote: "My grandfather opened this shop in 1968. For the first time, we're not just surviving against the chains — we're the #1 choice in Williamsburg. GB Optimizers made our story our biggest competitive advantage.",
  ...
  {
    slug: "toronto-law-firm",
    business: "Bay Street Legal Group",
    industry: "Legal",
    location: "Downtown Toronto, ON",
    image: "/images/case-study-ca-legal.jpg",
    imageAlt: "Law firm with Google Maps analytics on laptop",
    ownerImage: "/images/owner-david-harper.png",
    summary: "A mid-size law firm in Toronto needed to attract more local clients in a highly competitive Canadian legal market. We optimised their presence and built them into the #1 ranked firm downtown.",
    challenge: "Bay Street Legal Group was spending $10,000 CAD/month on Google Ads and legal directories with declining ROI. Ranking at #15 on Google Maps, they were losing clients to firms with stronger local SEO. Their profile had a single 'lawyer' category, no photos, and only 15 reviews. Competing firms had 200+ reviews and fully optimised profiles.",
    solution: "We implemented a Canadian legal market strategy with Law Society of Ontario compliance, targeting both English and French language searches. Built citations across CanLII, Canadian Lawyer Magazine directories, and provincial legal directories.",
    results: "Within 12 weeks, Bay Street Legal rose from #15 to #1 for family law and top 3 for 5 additional practice areas. Monthly consultation requests increased by 210%, and they reduced Google Ads spend by 80% — saving $8,000 CAD/month.",
    stats: [
      { label: "Ranking Improvement", value: "#15 → #1", color: "text-google-green" },
      { label: "Consultation Requests", value: "+210%", color: "text-google-blue" },
      { label: "Monthly Ad Savings", value: "$8K CAD", color: "text-google-red" },
      { label: "Review Growth", value: "15 → 140", color: "text-google-yellow" },
      { label: "Keywords in Top 3", value: "6", color: "text-google-green" },
      { label: "ROI", value: "11x", color: "text-google-blue" },
    ],
    timeline: [
      { week: "Week 1-3", title: "Canadian Legal Audit", description: "Analysed Toronto legal market, competitor profiling, and Law Society advertising guidelines compliance review.", color: "bg-google-blue" },
      { week: "Week 4-6", title: "Profile & Citation Build", description: "Added 6 practice area categories, Canadian legal directory citations, and bilingual content strategy.", color: "bg-google-red" },
      { week: "Week 7-9", title: "Review & Content Campaign", description: "Law Society-compliant review collection and educational Google Posts strategy.", color: "bg-google-yellow" },
      { week: "Week 10-12", title: "Multi-Keyword Expansion", description: "Expanded to 6 practice area keywords, all ranking top 3.", color: "bg-google-green" },
    ],
    strategies: [
      { title: "LSO-Compliant Review System", description: "Designed review collection that adhered to Law Society of Ontario advertising rules." },
      { title: "Bilingual Optimisation", description: "Targeted both English and French legal search terms, capturing Toronto's bilingual market." },
      { title: "Canadian Legal Directories", description: "Built citations across CanLII, Canadian Lawyer, and provincial directories." },
    ],
    testimonialQuote: "GB Optimizers understood the Canadian legal market perfectly. They navigated Law Society regulations and delivered results that transformed our client acquisition. We've grown 45% since starting.",
    testimonialAuthor: "David Harper",
    testimonialRole: "Managing Partner, Bay Street Legal Group",
    duration: "12 weeks",
    startRank: "#15",
    endRank: "#1",
    countries: ["ca"],
  ...
  {
    slug: "dubai-restaurant",
    business: "Majlis Al-Sultan Restaurant",
    industry: "Restaurant",
    location: "Dubai Marina, Dubai, UAE",
    image: "/images/case-study-ae-restaurant.jpg",
    imageAlt: "Restaurant interior with Google Maps listing in Dubai",
    ownerImage: "/images/owner-dubai-restaurant.png",
    summary: "A premium Arabic restaurant in Dubai Marina was losing diners to newer competitors. Our food-focused optimisation strategy made them the #1 restaurant in the area.",
    challenge: "Majlis Al-Sultan had been a Dubai Marina favourite for 8 years but was being outranked by new restaurants with aggressive social media and delivery app presence. At position #22 for 'restaurant near me,' they were invisible to the 80% of diners who discover restaurants through Google. Their profile had outdated photos, only 35 reviews, and no menu integration.",
    solution: "We crafted a Dubai-specific restaurant optimisation strategy leveraging Arabic and English bilingual content, Zomato and Talabat integration alongside Google, and a review strategy timed to post-dining satisfaction peaks with both Arabic and English review templates.",
    results: "Within 9 weeks, Majlis Al-Sultan climbed from #22 to #1 for restaurant keywords across Dubai Marina. Google Maps views surged from 2,500 to 18,000 per month. Weekend reservations are fully booked 2 weeks in advance.",
    stats: [
      { label: "Ranking Improvement", value: "#22 → #1", color: "text-google-green" },
      { label: "Monthly Maps Views", value: "18K+", color: "text-google-blue" },
      { label: "Weekend Bookings", value: "100%", color: "text-google-red" },
      { label: "Revenue Increase", value: "+55%", color: "text-google-yellow" },
      { label: "Review Growth", value: "35 → 250", color: "text-google-green" },
      { label: "Delivery Orders", value: "+120%", color: "text-google-blue" },
    ],
    timeline: [
      { week: "Week 1-2", title: "Dubai F&B Market Audit", description: "Analysed top 25 competing restaurants in Dubai Marina. Mapped Zomato, Talabat, and Google review profiles.", color: "bg-google-blue" },
      { week: "Week 3-4", title: "Bilingual Profile Overhaul", description: "Professional food photography, Arabic/English descriptions, Ramadan menu integration, and delivery platform links.", color: "bg-google-red" },
      { week: "Week 5-7", title: "Review & Content Campaign", description: "Bilingual review collection via NFC table cards. Weekly posts featuring seasonal menus and cultural events.", color: "bg-google-yellow" },
      { week: "Week 8-9", title: "Results & Expansion", description: "Achieved #1 ranking. Expanded to JBR and Downtown Dubai keyword targeting.", color: "bg-google-green" },
    ],
    strategies: [
      { title: "Bilingual Arabic/English Content", description: "All profile content optimised in both Arabic and English, capturing the UAE's diverse dining market." },
      { title: "Ramadan & Cultural Events Strategy", description: "Specialised content calendar for Ramadan Iftar menus, Eid celebrations, and UAE National Day — driving seasonal traffic peaks." },
      { title: "Delivery Platform Integration", description: "Linked Talabat, Zomato, and Deliveroo alongside Google ordering for maximum order capture." },
    ],
    testimonialQuote: "Dubai's restaurant scene is fierce. GB Optimizers understood the unique challenge of marketing in a multilingual, multicultural city. We're now the #1 ranked restaurant in Dubai Marina.",
    testimonialAuthor: "Sultan Al-Maktoum",
    testimonialRole: "Owner, Majlis Al-Sultan Restaurant",
    duration: "9 weeks",
    startRank: "#22",
    endRank: "#1",
    countries: ["ae"],
  ...
  {
    slug: "doha-fitness-club",
    business: "Pearl Fitness Club",
    industry: "Fitness",
    location: "The Pearl, Doha, Qatar",
    image: "/images/case-study-qa-fitness.jpg",
    imageAlt: "Modern gym with Google Maps listing in Doha",
    ownerImage: "/images/owner-doha-fitness.png",
    summary: "A boutique fitness club in Doha's Pearl district was losing members to international gym chains. Our hyper-local strategy made them the #1 rated gym in the area.",
    challenge: "Pearl Fitness Club was struggling against Fitness First and Gold's Gym at position #18. With only 15 reviews against chains averaging 400+, and a basic Google profile, potential members couldn't find them.",
    solution: "We positioned Pearl Fitness as the premium, results-focused alternative with ladies-only sessions and Arabic-speaking trainers — unique selling points chains couldn't match. Combined with bilingual review collection and Ramadan-specific fitness content.",
    results: "In 8 weeks, Pearl Fitness rocketed from #18 to #2. Monthly sign-ups jumped from 6 to 28. Member retention improved from 82% to 95%.",
    stats: [
      { label: "Ranking Improvement", value: "#18 → #2", color: "text-google-green" },
      { label: "Monthly Sign-ups", value: "6 → 28", color: "text-google-blue" },
      { label: "Profile Views", value: "10K/mo", color: "text-google-red" },
      { label: "Revenue Growth", value: "+85%", color: "text-google-yellow" },
      { label: "Review Growth", value: "15 → 120", color: "text-google-green" },
      { label: "Member Retention", value: "95%", color: "text-google-blue" },
    ],
    timeline: [
      { week: "Week 1-2", title: "Qatar Fitness Audit", description: "Mapped 12 competing gyms in The Pearl and West Bay areas.", color: "bg-google-blue" },
      { week: "Week 3-4", title: "Profile & Photography", description: "Professional shoot, bilingual content, ladies-only session highlights.", color: "bg-google-red" },
      { week: "Week 5-6", title: "Review & Citation Building", description: "Arabic/English review campaigns and Qatar-specific directory submissions.", color: "bg-google-yellow" },
      { week: "Week 7-8", title: "Results", description: "Achieved #2 ranking with plans to reach #1.", color: "bg-google-green" },
    ],
    strategies: [
      { title: "Ladies-Only Positioning", description: "Highlighted gender-segregated sessions, a unique offering that international chains couldn't easily replicate in Qatar's market." },
      { title: "Ramadan Fitness Content", description: "Created specialised content around pre-Suhoor and post-Iftar workout schedules, capturing a niche search demand." },
    ],
    testimonialQuote: "GB Optimizers understood Qatar's unique fitness market. They highlighted what makes us special and now we're the top-rated boutique gym in The Pearl.",
    testimonialAuthor: "Ahmed Al-Thani",
    testimonialRole: "Owner, Pearl Fitness Club",
    duration: "8 weeks",
    startRank: "#18",
    endRank: "#2",
    countries: ["qa"],
  ...
  {
    slug: "muscat-real-estate",
    business: "Oman Coastal Properties",
    industry: "Real Estate",
    location: "Al Mouj, Muscat, Oman",
    image: "/images/case-study-om-realestate.jpg",
    imageAlt: "Real estate office with Google Maps in Muscat",
    ownerImage: "/images/owner-muscat-realestate.png",
    summary: "A boutique real estate agency in Muscat's Al Mouj was being outranked by international agencies. Our local-expert strategy made them the dominant agency in the area.",
    challenge: "Oman Coastal Properties had 12 years of local expertise but ranked #14 on Google Maps. International franchises dominated with bigger budgets and more reviews. Their profile had a single listing, 10 reviews, and no differentiation.",
    solution: "We positioned them as Oman's authentic local property experts with bilingual Arabic/English optimisation, Oman-specific real estate directory citations, and a review system targeting both landlords and tenants.",
    results: "Within 11 weeks, they achieved #1 ranking in Al Mouj and #2 in Qurum. Monthly enquiries increased by 250% and new exclusive listings doubled.",
    stats: [
      { label: "Ranking Achievement", value: "#1 in Al Mouj", color: "text-google-green" },
      { label: "Monthly Enquiries", value: "+250%", color: "text-google-blue" },
      { label: "Exclusive Listings", value: "2x", color: "text-google-red" },
      { label: "Review Growth", value: "10 → 95", color: "text-google-yellow" },
      { label: "Profile Views", value: "8K/mo", color: "text-google-green" },
      { label: "ROI", value: "9x", color: "text-google-blue" },
    ],
    timeline: [
      { week: "Week 1-3", title: "Oman Market Analysis", description: "Mapped competing agencies across Muscat, analysed Bayut and Property Finder presence.", color: "bg-google-blue" },
      { week: "Week 4-6", title: "Profile & Citation Build", description: "Bilingual profile, Oman-specific directories, and professional property photography.", color: "bg-google-red" },
      { week: "Week 7-9", title: "Review & Content", description: "Dual landlord/tenant review system and weekly market insight posts.", color: "bg-google-yellow" },
      { week: "Week 10-11", title: "Results & Scaling", description: "Achieved #1 in Al Mouj, expanding to Qurum and Shatti Al Qurum.", color: "bg-google-green" },
    ],
    strategies: [
      { title: "Bilingual Property Listings", description: "All content in Arabic and English, capturing Oman's diverse expat and local property market." },
      { title: "Oman Directory Network", description: "Citations across Bayut, Property Finder, and Oman-specific directories for maximum local authority." },
    ],
    testimonialQuote: "GB Optimizers understood Oman's property market perfectly. We're now the #1 agency in Al Mouj and enquiries have never been higher.",
    testimonialAuthor: "Maryam Al-Said",
    testimonialRole: "Director, Oman Coastal Properties",
    duration: "11 weeks",
    startRank: "#14",
    endRank: "#1",
    countries: ["om"],
